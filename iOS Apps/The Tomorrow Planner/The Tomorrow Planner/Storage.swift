...
//
//  Created by Abram Andis on 4/26/19.
//  Copyright © 2019 Small Blue Idea, Inc. All rights reserved.
//
//  Used for saving JSON encodable DATA to local directory on the phone
...
public class Storage {
    ...
    static func retrieve<T: Decodable>(_ fileName: String, from directory: Directory, as type: T.Type) -> T? {
        ...
        if !FileManager.default.fileExists(atPath: url.path) {
            ...
            print("storage: NO DATA AT DIRECTORY!!")
            return nil
        }
        ...
        if let data = FileManager.default.contents(atPath: url.path) {
            ...
            fatalError("storage: No data at \(url.path)!")
        }
    }
